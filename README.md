...
This repository contains the code implementation accompanying the paper: **$\beta$-SGP: Scaled Gradient Projection with $\beta$-divergence for astronomical image restoration** [Link to preprint to be uploaded soon]. It is aimed at single-image deconvolution of astronomical images with a known Point Spread Function.
